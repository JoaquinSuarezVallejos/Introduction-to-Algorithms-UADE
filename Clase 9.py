# Introducción a la Algoritmia - Clase 9
...
# Ejercicio 3: Sumar los elementos de una matriz de 2x2. Pasos: 
# Crear una matriz de 2x2 con números aleatorios de 0 a 9. 
...
print("La suma de los elementos de la matriz es igual a: ", suma)
...
print("Matriz después de multiplicar por el número ingresado: ")
for f in range(len(matriz_cuatro_por_cuatro)):
    for c in range(len(matriz_cuatro_por_cuatro[f])):
